            ...
            <div className="flex h-14 items-center justify-between border-b boder-zinc-200">
                ...
                <div className='h-full flex items-center space-x-4'>
                    {user?(
                        ...
                        <Link href="/configure/upload" className={buttonVariants({size:'sm',variant:"ghost",className: "hidden sm:flex items-center gap-1"})}>
                            Create Case
                        ...
                        <Link href="/api/login"className={buttonVariants({size:'sm',variant:"ghost"})}>
                            Login
                        </Link>
